...
**Priority:** Medium
**Labels:** none
**URL:** https://hpe-team2.atlassian.net/browse/KAN-10

**Description:**
Implement the PUT /appointments/{id} endpoint to allow updating an existing appointment's time and status.   Requirements: Accept appointment_id as a path parameter Accept time and status fields in the request body Return the updated appointment object with all fields Return 404 Not Found if the appointment does not exist Do not modify any already working endpoints
