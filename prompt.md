...
### Jira Ticket: KAN-4
**Summary:** Add Cancel Appointment API
**Status:** To Do
**Priority:** Medium
**Labels:** none
**URL:** https://hpe-team2.atlassian.net/browse/KAN-4

**Description:**
Add endpoint to cancel an appointment by ID. Endpoint: DELETE /appointments/{id} Expected behavior: Remove appointment from database and return success message.
