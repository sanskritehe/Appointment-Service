...
### Jira Ticket: KAN-15
**Summary:** Implement GET /appointments/{id} endpoint
**Status:** In Progress
**Priority:** Medium
**Labels:** none
**URL:** https://hpe-team2.atlassian.net/browse/KAN-15

**Description:**
Add endpoint to Appointment Database Service to fetch a single appointment by ID. Endpoint: GET /appointments/{id} Requirements: Accept id as integer path parameter Return appointment if found Return 404 if not found Response: {   "id": 1,   "user": "string",   "time": "string",   "status": "booked" } Error: {   "detail": "Appointment not found" } Service: Appointment-Database-Service Port: 8000
