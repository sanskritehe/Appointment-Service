...
### Jira Ticket: KAN-5
**Summary:** Add API endpoint to update appointment time
**Status:** In Progress
**Priority:** Medium
**Labels:** none
**URL:** https://hpe-team2.atlassian.net/browse/KAN-5

**Description:**
Add API endpoint to update appointment time Implement an API endpoint that allows updating the scheduled time of an existing appointment. Currently the system supports: Creating appointments Retrieving appointments Deleting appointments However, there is no way to reschedule an existing appointment. This feature will allow users to modify the appointment time. The endpoint should update the "time" field of the appointment in the database and return the updated appointment details. PUT /appointments/{appointment_id} appointment_id: int The ID of the appointment to update. {   "id": 3,   "user": "Viraj",   "time": "2026-03-01T11:00:00" }
