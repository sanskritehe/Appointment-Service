...
### Jira Ticket: KAN-19
**Summary:**   Create appointment booking endpoint for new patient registration
**Status:** In Progress
**Priority:** Medium
**Labels:** none
**URL:** https://hpe-team2.atlassian.net/browse/KAN-19

**Description:**
  As a healthcare provider, I need a POST endpoint to create a new appointment   for a patient in the system.   Acceptance Criteria: Endpoint accepts patient ID, doctor ID, date, and time slot Appointment record is persisted to the appointment database Returns the created appointment ID and confirmation status Validates that the requested time slot is not already booked
