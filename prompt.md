...
### Jira Ticket: KAN-20
**Summary:** Implement query-parameter-based pagination (page, limit) for the GET /appointments endpoint across both services.
**Status:** To Do
**Priority:** Medium
**Labels:** none
**URL:** https://hpe-team2.atlassian.net/browse/KAN-20

**Description:**
  Implement query-parameter-based pagination (page, limit) for the GET /appointments endpoint across both services.   Acceptance Criteria- GET /appointments?page=1&limit=10 returns a paginated response in the Appointment Service The Appointment Database Service exposes a corresponding paginated query endpoint (e.g. GET /appointments?offset=0&limit=10) Response includes total, page, limit, and data fields Default limit is 10, max is 100 Invalid params return 400  
